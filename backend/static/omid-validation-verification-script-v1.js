...
function fireEvent(event) {
    var params = serialize(event),
        url = "https://10.0.2.2:8000/events/sendmessage?" + params;
    fireURL(url);
}
...
(function(omidGlobal) {
    ...
    fireURL("https://10.0.2.2:8000/events/sendmessage?version=" + key);

    if (!verificationClient.isSupported()) {
        fireURL("https://10.0.2.2:8000/events/sendmessage?supported=no");
    ...
    fireURL("https://10.0.2.2:8000/events/sendmessage?supported=yes");
